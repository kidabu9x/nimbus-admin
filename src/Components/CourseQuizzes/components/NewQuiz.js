...
class NewQuiz extends Component {
  ...
  goIntoView = () => {
    this.rect.current.scrollIntoView({ behavior: "smooth" });
  };

  componentDidUpdate() {
    if (this.props.showNewQuiz) this.goIntoView();
  }

  render() {
    const { classes, onCancel, creating, showNewQuiz } = this.props;
    ...
    return (
      <Card className={classes.root} ref={this.rect}>
        ...
        <CardHeader
          ...
          title={<Typography variant="body1">Tạo bài trắc nghiệm</Typography>}
